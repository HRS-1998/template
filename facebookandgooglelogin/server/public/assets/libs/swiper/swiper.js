    ...
    var a,
        t = function (e, i) {
            ...
            function l(e, a) {
                ...
                r.observe(e, {
                    attributes:
                        'undefined' == typeof a.attributes ? !0 : a.attributes,
                    childList:
                        'undefined' == typeof a.childList ? !0 : a.childList,
                    characterData:
                ...
                if (
                    ...
                    if (37 === a || 39 === a || 38 === a || 40 === a) {
                        ...
                        if (
                            ...
                            0 ===
                                b.container.parents('.swiper-slide-active')
                                    .length
                        )
                            return;
                        var r = {
                    ...
                    b.isHorizontal()
                        ? ((37 === a || 39 === a) &&
                              (e.preventDefault
                                  ? e.preventDefault()
                                  : (e.returnValue = !1)),
                          ((39 === a && !b.rtl) || (37 === a && b.rtl)) &&
                              b.slideNext(),
                          ((37 === a && !b.rtl) || (39 === a && b.rtl)) &&
                              b.slidePrev())
                        : ((38 === a || 40 === a) &&
                              (e.preventDefault
                                  ? e.preventDefault()
            ...
            if (
                    ...
                    (b.setBreakpoint = function () {
                        ...
                        if (e && b.currentBreakpoint !== e) {
                            var a =
                                ...
                                t =
                                    b.params.loop &&
                                    a.slidesPerView !== b.params.slidesPerView;
                ...
                (b.container[0].swiper = b),
                    ...
                    b.params.freeMode &&
                        b.classNames.push('swiper-container-free-mode'),
                    b.support.flexbox ||
                    ...
                    ['cube', 'coverflow', 'flip'].indexOf(b.params.effect) >=
                        0 &&
                    ...
                    'slide' !== b.params.effect &&
                        b.classNames.push(
                            'swiper-container-' + b.params.effect
                        ),
                    ...
                    b.params.pagination &&
                        ...
                        b.params.uniqueNavElements &&
                            ...
                            1 ===
                                b.container.find(b.params.pagination).length &&
                    ...
                    b.device.android &&
                        b.classNames.push('swiper-container-android'),
                    ...
                    (b.lockSwipes = function () {
                        b.params.allowSwipeToNext = b.params.allowSwipeToPrev =
                            !1;
                    }),
                            ...
                            if (!b.params.centeredSlides) {
                                ...
                                (b.snapGrid = f),
                                    Math.floor(b.virtualSize - b.size) -
                                        Math.floor(
                                            b.snapGrid[b.snapGrid.length - 1]
                                        ) >
                                        1 &&
                    ...
                    (b.updateSlidesProgress = function (e) {
                        if (
                            ...
                            'undefined' ==
                                typeof b.slides[0].swiperSlideOffset &&
                                b.updateSlidesOffset();
                            var a = -e;
                            b.rtl && (a = e),
                ...
                if (
                    ((b.onTouchStart = function (e) {
                        if (
                            ...
                            if (
                                b.params.noSwiping &&
                                o(e, '.' + b.params.noSwipingClass)
                            )
                                return void (b.allowClick = !0);
                            if (
                                !b.params.swipeHandler ||
                                o(e, b.params.swipeHandler)
                            ) {
                    ...
                    (b.onTouchEnd = function (e) {
                        if (
                            ...
                            for (
                                ...
                                'undefined' !=
                                typeof b.slidesGrid[v + b.params.slidesPerGroup]
                                    ? i >= b.slidesGrid[v] &&
                                      i <
                                          b.slidesGrid[
                                              v + b.params.slidesPerGroup
                    ...
                    (b.slideTo = function (e, a, t, r) {
                        ...
                        for (var s = 0; s < b.slidesGrid.length; s++)
                            -Math.floor(100 * i) >=
                                Math.floor(100 * b.slidesGrid[s]) && (e = s);
                            ...
                            if (b.params.lazyLoadingInPrevNext)
                                if (
                                    ...
                                    for (
                                        ...
                                        b.slides[e] &&
                                            b.lazy.loadImageInSlide(e);
                                    for (e = s; e < b.activeIndex; e++)
                                        b.slides[e] &&
                                            b.lazy.loadImageInSlide(e);
                                } else {
                                    var n = b.wrapper.children(
                                        '.' + b.params.slideNextClass
                                    );
                                    n.length > 0 &&
                                        b.lazy.loadImageInSlide(n.index());
                                    var o = b.wrapper.children(
                                        '.' + b.params.slidePrevClass
                                    );
                                    o.length > 0 &&
                                        b.lazy.loadImageInSlide(o.index());
                                }
                        },
                            ...
                            if (b.params.scrollbar) {
                                ...
                                (e.track = a(b.params.scrollbar)),
                                    b.params.uniqueNavElements &&
                                        ...
                                        e.track.length > 1 &&
                                        1 ===
                                            b.container.find(b.params.scrollbar)
                                                .length &&
                                        (e.track = b.container.find(
                                            b.params.scrollbar
                                        )),
                                    (e.drag = e.track.find(
                            ...
                            function r(a) {
                                (e =
                                    ...
                                    'slide' === b.params.controlBy &&
                                        ...
                                        (s = -b.controller.spline.interpolate(
                                            -e
                                        ))),
                ...
                return (
                    ...
                    (b.emit = function (e) {
                        ...
                        if (b.emitterEventListeners[e])
                            for (
                                a = 0;
                                a < b.emitterEventListeners[e].length;
                                a++
                            )
